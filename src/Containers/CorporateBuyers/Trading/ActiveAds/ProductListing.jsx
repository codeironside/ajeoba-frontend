...
import { styles } from "../../../../Components/LandingPage/ProductListing/ProductListingExpanded/ProductList";
                  ...
                  <CardContent sx={{ ...styles.details }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "baseline" }}>
                      ...
                      <Typography
                        ...
                        color="text.secondary"
                      >
                        {`(per ${textCapitalize(item?.unit_of_measurement)})`}
                      </Typography>
                    </Box>
                  </CardContent>
                </CardActionArea>{" "}
