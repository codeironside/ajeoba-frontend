...
import { getOrderInputDetailsActionById } from "../../../../../../Redux/CorporateBuyer/Trading/tradingActions";
import {
...
export default function OrderDetails(props) {
  ...
  useEffect(() => {
    dispatch(getOrderInputDetailsActionById(id));
  }, [id]);
        ...
        <Box sx={{ ...commonStyles.detailsContainer }}>
                  ...
                  <Box sx={{...commonStyles.boxInfo_2}}>
                    <Box sx={{...commonStyles.oInfo}}>
                        <Box sx={{...commonStyles.label}}>
                          ...
                          <Skeleton sx={{...commonStyles.text}} displayText={"Order ID"} />
                        </Box>
                        <Box sx={{display: "flex", gap: "8px"}}> 
                            <Skeleton sx={{...commonStyles.titleInfo}} displayText={corporateDetails?.orderDetail?.order_id} />
                    ...
                    <Box sx={{...commonStyles.oInfo}}>
                        <Box sx={{...commonStyles.label}}>
                          ...
                          <Skeleton sx={{...commonStyles.text}} displayText={"Order Date"} />
                        </Box>
                        <Skeleton
          ...
          <Box sx={{...imageStyle.imageBoxDetail, ...commonStyles.insideDetailsContainer}}>
                <Box sx={{ ...commonStyles.infoContainer }}> 
                    <Box sx={{...commonStyles.product}}>
                      <AjTypography
                        displayText={corporateDetails?.orderDetail?.input_name}
                        sx={{...commonStyles.productName}}
                      />
                      <AjTypography
                        displayText={status}
                    ...
                    <Box sx={{...commonStyles.otherInfo}}>
                      ...
                      <Box sx={{...commonStyles.boxInfo}}>
                        <Box sx={{...commonStyles.oInfo}}>
                            ...
                            <AjTypography sx={{...commonStyles.titleInfo}} displayText={corporateDetails?.orderDetail?.input_subtype} />
                        </Box>
                        <Box sx={{...commonStyles.oInfo}}>
                            <Box sx={{...commonStyles.label}}>
                              <img
                         ...
                         <Box 
                           ...
                           >
                             ...
                             <Box sx={{display: "flex", fontSize: ".5rem", gap: "4px"}}>
                               ...
                               {/* <Typography sx={{color: "#000", fontSize: "1rem"}}>{" - " + item?.quantity + " " + unitOfMeasurement}</Typography> */}
                             </Box>
                         </Box>
                         <Box 
                             key={index}
