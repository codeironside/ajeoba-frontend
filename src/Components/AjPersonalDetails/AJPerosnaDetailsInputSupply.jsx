...
function AJPerosnaDetailsInputSupply(props) {
  const {
    register,
    setValue,
    handleSubmit,
  ...
  const setValues = () => {
    if (props.defaultFirstName) {
      setValue("firstName", props.defaultFirstName, {
        shouldValidate: true,
      });
    }
        ...
        <Box sx={{ ...commonStyles.signupFormField }}>
          ...
          <InputBase
            ...
            sx={{
              ...
              ...((props.isDisable || props.uneditable) &&
...
export default AJPerosnaDetailsInputSupply;
