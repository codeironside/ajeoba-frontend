...
import { signUpAggregatorDetails } from "../../Redux/SignUpAggregationDetails/signUpAggregationDetailsActions";
...
import { HtmlTooltip, styles } from "./AjSignupAggregatorDetailsStyles";
import AjDialog from "../AjDialog/AjDialog";
import VninModalContent from "../VninHow/VninModal";

const AjSignupAggregatorDetails = () => {
  ...
  const {
    ...
    resolver: yupResolver(aggregatorDetailsSchema),
    mode: "onChange",
  });
  useEffect(() => {
  ...
  const onSubmit = (data) => {
    ...
    if (addressData.zipCode) {
      aggregatorDetails["zipCode"] = parseInt(addressData.zipCode);
    }
    dispatch(signUpAggregatorDetails(aggregatorDetails, navigate));
  };
...
export default AjSignupAggregatorDetails;
