...
import AjDocumentUploaderInputSupply from "../AjDocumentUploaderInputSupply";
...
const AjUploadCACDocumentInputSupply = (props) => {
  const {
    handleSubmit,
    setValue,
    formState: { errors },
...
export default AjUploadCACDocumentInputSupply;
